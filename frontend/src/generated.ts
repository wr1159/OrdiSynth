...
/**
 * - [__View Contract on Rootstock Testnet Rsk Explorer__](https://explorer.testnet.rootstock.io/address/0x6d601b3a60Ec0a08e61dC7084C7EDAa457E77476)
 * -
 */
export const ordiSynthAbi = [
  {
    type: 'constructor',
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'tokenId', internalType: 'uint256', type: 'uint256' },
      { name: 'runeAmount', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'addLiquidityToRouter',
    outputs: [],
    stateMutability: 'payable',
  },
  {
    ...
    name: 'availableRuneByContractAddressAndTokenId',
    outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    type: 'function',
    inputs: [{ name: '', internalType: 'address', type: 'address' }],
    name: 'ownedRuneByContractAddress',
    outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    type: 'function',
    inputs: [{ name: '', internalType: 'address', type: 'address' }],
    name: 'synthAddressByContractAddress',
    outputs: [{ name: '', internalType: 'address', type: 'address' }],
    stateMutability: 'view',
  },
 ...
 * -
 */
export const ordiSynthConfig = {
  address: ordiSynthAddress,
  abi: ordiSynthAbi,
} as const
...
/**
 * - [__View Contract on Rootstock Testnet Rsk Explorer__](https://explorer.testnet.rootstock.io/address/0xF4A48a6DbCfC9547A1661cF8B5762d2A7451AeE5)
 * -
 */
export const runeTokenAbi = [
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'runeName', internalType: 'string', type: 'string' },
      { name: 'amount', internalType: 'uint256', type: 'uint256' },
      { name: 'owner', internalType: 'address', type: 'address' },
    ],
    name: 'freezeTokens',
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct RuneToken.TokenInfo',
        type: 'tuple',
        components: [
          ...
          {
            name: 'defaultMintAmount',
            internalType: 'uint256',
            type: 'uint256',
          },
          {
            name: 'balance',
            internalType: 'struct RuneToken.Balance',
            type: 'tuple',
            components: [
              { name: 'account', internalType: 'address', type: 'address' },
              { name: 'balance', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'defaultMintAmount', internalType: 'uint256', type: 'uint256' },
 ...
 * -
 */
export const runeTokenConfig = {
  address: runeTokenAddress,
  abi: runeTokenAbi,
} as const
