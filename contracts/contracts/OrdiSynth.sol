...
contract OrdiSynth is ERC1155Holder {
  ...
  function depositForSynth(address contractAddress, uint tokenId, uint256 erc1155Amount) public {
    ...
    rune.safeTransferFrom(msg.sender, address(this), tokenId, erc1155Amount, "");
    ...
    ownedRuneByContractAddress[contractAddress] += erc1155Amount;
    availableRuneByContractAddressAndTokenId[contractAddress][tokenId] += erc1155Amount;
  ...
  function redeemSynth(address contractAddress, uint tokenId, uint256 erc1155Amount) public {
    ...
    rune.safeTransferFrom(address(this), msg.sender, tokenId, erc1155Amount, "");
    return;
  }
  ...
  // swapTokenFor1155 is a function that allows users to swap any rBTC on the uniswap pool for synth tokens
